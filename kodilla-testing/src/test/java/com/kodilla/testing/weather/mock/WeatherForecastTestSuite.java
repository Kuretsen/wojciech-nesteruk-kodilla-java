...
public class WeatherForecastTestSuite {
    ...
    @DisplayName
            ("Testing calculating average temperature")
    @Test
    ...
    @DisplayName
            ("Testing median temperature with odd values")
    @Test
    ...
    @DisplayName
            ("Testing median temperature with even values")
    @Test
    void testMedianTemperatureEven() {
        ...
        temperaturesMap.put("Warszawa", 25.2);
        temperaturesMap.put("Gdansk", 26.1);
        temperaturesMap.put("Suwałi", 24.2);
        when(temperaturesMock.getTemperatures()).thenReturn(temperaturesMap);
        WeatherForecast weatherForecast = new WeatherForecast(temperaturesMock);
        //When
        double result = weatherForecast.medianTemperature();
