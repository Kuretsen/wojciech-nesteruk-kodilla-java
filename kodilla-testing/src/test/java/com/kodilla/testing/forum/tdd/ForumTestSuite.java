...
public class ForumTestSuite {
    ...
    class TestComments {
        ...
        void testAddComment() {
            //Given
            ForumUser forumUser = new ForumUser("mrsmith", "John Smith");
            ForumPost thePost = new ForumPost("Hello everyone, " + "this is my forst contribution here!", "mrsmith");
            //When
        ...
        void testGetComment() {
            ...
            ForumUser forumUser = new ForumUser("mrsmith", "John Smith");
            ForumPost thePost = new ForumPost("Hello everyone, " + "this is my first contribution here!", "mrsmith");
            ForumComment theComment = new ForumComment(thePost, "mrsmith", "Than you for all good words!");
